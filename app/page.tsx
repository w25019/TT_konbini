      ...
      <div className="simple-home">
        <section className="simple-hero">
          <div className="simple-hero-copy">
            ...
            <span>
              おにぎり・飲み物・お菓子など、身近な商品をそろえています。
            </span>
            <div className="simple-hero-buttons">
              <Link className="primary" href="/products">
                商品を見る
              </Link>
              <Link className="outline" href="/products?deal=1">
                セール商品
              </Link>
            </div>
          </div>
          <img
            src="/banners/hero-products-v2.png"
            alt="コンビニ商品のイメージ"
          />
        </section>
        ...
        <section className="simple-section">
          ...
          <div className="simple-categories">
            {categories.slice(0, 6).map((category) => (
              ...
              >
                <ProductImage
                  product={categoryProducts[categories.indexOf(category)]}
                />
                <span>{category}</span>
              </Link>
            ))}
        ...
        <section className="simple-notice">
          <h2>このサイトについて</h2>
          <p>
            学校のポートフォリオとして制作した、オンラインコンビニのデモサイトです。
          </p>
          <p>
            商品検索から注文完了までECサイトの基本的な流れを体験できます。実際の注文や決済は行われません。
          </p>
